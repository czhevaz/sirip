...
class M_indeks_pegawai extends CI_Model
{
    ...
    // datatables
    function json() {
        $this->datatables->select('ID_PEGAWAI,NIK,NAMA_PEGAWAI,mstr_level.DESCP_LEVEL as Jabatan, mstr_ruangan.DESCP_RUANGAN as NamaRuangan,
...
//        $this->datatables->add_column('action', anchor(site_url('admin/indeks_pegawai/read/$1'),'Read')." | ".anchor(site_url('admin/indeks_pegawai/update/$1'),'Update')." | ".anchor(site_url('admin/indeks_pegawai/delete/$1'),'Delete','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'), 'ID_PEGAWAI');
...
/* End of file M_indeks_pegawai.php */
/* Location: ./application/models/M_indeks_pegawai.php */
