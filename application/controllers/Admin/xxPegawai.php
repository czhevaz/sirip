...
class Pegawai extends CI_Controller
{
    ...
    {
        $this->load->view('admin/pegawai/mstr_pegawai_list');
    }
    ...
    public function read($id)
    {
		...
		'PHOTO' => $row->PHOTO,
            ...
            $this->load->view('admin/pegawai/mstr_pegawai_read', $data);
        } else {
    ...
    public function create()
    {
        ...
        $this->load->view('admin/pegawai/mstr_pegawai_form', $data);
    }
...
/* Generated by Harviacode Codeigniter CRUD Generator 2018-04-26 00:50:45 */
/* http://harviacode.com */
